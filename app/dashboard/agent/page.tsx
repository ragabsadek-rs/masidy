...
const AGENTS = [
  {
    ...
    name: "Masidy Lite",
    tier: "Fast",
    desc: "Best for quick answers, small fixes, and short code snippets. Use this for simple questions and lightweight changes.",
    cost: "0.5 credits / message",
    color: "bg-green-500",
    features: ["Quick responses", "Small bug fixes", "Code explanations"],
  },
  {
    id: "standard",
    name: "Masidy Standard",
    tier: "Balanced",
    desc: "Balanced mode for feature development, UI work, and moderate build tasks. Good for building components and app flows.",
    cost: "2 credits / message",
    color: "bg-blue-500",
    features: ["Feature implementation", "Refactors", "UI/UX work"],
  },
  {
    id: "opus",
    name: "Masidy Pro",
    tier: "Powerful",
    desc: "Best for full-stack app generation, architecture, and larger deployments. Use this for full projects and end-to-end workflows.",
    cost: "5 credits / message",
    color: "bg-purple-500",
    features: ["Full project scaffolding", "Deployment-ready apps", "Autonomous workflows"],
  },
];
